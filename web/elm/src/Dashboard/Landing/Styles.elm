module Dashboard.Landing.Styles exposing
    ( arrow
    , column
    , hamburgerIcon
    , hamburgerMenu
...
teamIcon : { isHovered : Bool } -> Html.Html msg
teamIcon { isHovered } =
    Icon.icon
        { sizePx = 20
...
pipelineIcon : { isHovered : Bool } -> List (Html.Attribute msg)
pipelineIcon { isHovered } =
